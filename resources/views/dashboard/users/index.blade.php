                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            <tr>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Design
                                    Director</td>
                                ...
                                <td climage }}" alt=" py-4 text-sm whitespace-nowrap">
                            ...
                            <tr>
                                    ...
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            <img class="object-cover w-10 h-10 rounded-full"
                                                ...
                                                alt="">
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Amelia. Anderson
                                                </h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">
                                                    @ameliaanderson</p>
                                            </div>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Lead
                                    Developer</td>
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                    ...
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@junior
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            <img class="object-cover w-10 h-10 rounded-full"
                                                ...
                                                alt="">
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Olivia Wathan
                                                </h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">
                                                    @oliviawathan</p>
                                            </div>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Graphic
                                    Designer</td>
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                    mia@example.com</td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
