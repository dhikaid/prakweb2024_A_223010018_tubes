...
<section class="roles">
    <div class="flex flex-col">
        <div class="info my-4">
            @include('dashboard.layouts.partials.breadcumb', [$datas = ['Events', $event->name, 'Tickets', 'Create']])
            <div class="flex items-center gap-3 my-2">
                ...
                <h1 class="text-2xl md:text-3xl uppercase font-bold">Create Ticket : {{ $event->name }}</h1>
            </div>
        </div>
            ...
            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                <div class="overflow-hidden md:rounded-lg">
                    <div class=" rounded-lg flex items-start justify-between">
                        <div class="w-full">
                            <form class="space-y-5" method="POST" action="/dashboard/events/{{ $event->uuid }}/tickets"
