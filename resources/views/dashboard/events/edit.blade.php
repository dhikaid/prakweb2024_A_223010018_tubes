...
<section class="events">
    <div class="flex flex-col">
        <div class="info my-4">
            @include('dashboard.layouts.partials.breadcumb',[$datas = ['Events',$event->name, 'Edit']])
                ...
                <div class="overflow-hidden md:rounded-lg">
                    <div class=" rounded-lg flex items-start justify-between">
                        <div class="w-full">
                            ...
                            <form class="space-y-5" method="POST" action="/dashboard/events/{{ $event->uuid }}"
                                enctype="multipart/form-data"
                                x-data="{ verified: {{ old('war_ticket', $event->is_tiket_war ? 'true' : 'false' ) }} }">
                                @csrf
                                @method('put')
                                {{-- START FILE FORM --}}
                                <div>
                                    ...
                                    <div class="layout-1 w-full">
                                        ...
                                        <div class="mt-4 w-full">
                                            ...
                                            <select
                                                ...
                                                <option value="{{ $category->uuid }}" {{ $category->uuid ===
                                                    $event->category_uuid ? 'selected' : '' }}>{{ $category->name }}
                                                </option>
                                                @endforeach
                                            </select>
                                            @error('category')
                                    ...
                                    <div class="layout-2 w-full">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="relative flex items-center mt-2">
                                                    ...
                                                    <input type="datetime-local"
                                                        ...
                                                        value="{{ old('start_date', $event->startTime) }}">
                                                </div>
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="relative flex items-center mt-2">
                                                    ...
                                                    <input type="datetime-local"
                                                        ...
                                                        value="{{ old('end_date', $event->endTime  ) }}">
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select
                                                ...
                                                required>
                                                <option value="1" {{ $event->is_tiket_war == true ? 'selected' : ''
                                                    }}>Yes</option>
                                                <option value="0" {{ $event->is_tiket_war != true ? 'selected' : ''
                                                    }}>No</option>
                                            </select>
                                            @error('is_tiket_war')
                                            <p class="mt-3 text-xs text-red-400">{{ $message }} </p>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="relative flex items-center mt-2">
                                                    ...
                                                    <input type="number" min="1" max="200"
                                                        class="block w-full py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                                        name="queue_limit"
                                                        value="{{ old('queue_limit', $event->queue_limit) }}">
                                                </div>
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="relative flex items-center mt-2">
                                                    ...
                                                    <input type="datetime-local"
                                                        class="block w-full py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                                        name="queue_open"
                                                        value="{{ old('queue_open', $event->startwartime) }}">
                                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('country', $event->locations->country) }}">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center mt-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('province', $event->locations->province) }}">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center mt-2">
                                        ...
                                        <input type="text"
                                            class="block w-full py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                            name="city" required value="{{ old('city', $event->locations->city) }}">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center mt-2">
                                        ...
                                        <input type="text"
                                            class="block w-full py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                            name="venue" required value="{{ old('venue', $event->locations->venue) }}">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center mt-2">
                                        ...
                                        <input type="number"
                                            class="block w-full py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                            name="capacity" required value="{{ old('capacity', $event->capacity) }}"
                                            min="1">
                                    </div>
