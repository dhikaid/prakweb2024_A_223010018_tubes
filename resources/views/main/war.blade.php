...
<div class="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
    ...
    <!-- Main Content -->
    <div class="container max-w-screen-xl mx-auto px-5 mt-28">
        <!-- Back Button -->
                    ...
                    <div class="bg-white rounded-3xl shadow-xl shadow-black/5 p-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div
                                ...
                                <div
                                    class="flex-none flex items-center justify-center w-12 h-12 bg-blue-100 rounded-xl">
                        ...
                        <div class="mt-8 pt-8 border-t border-gray-100">
                            ...
                            <div class="flex items-center gap-4 bg-slate-50 p-4 rounded-xl">
                                <img src="https://i2.wp.com/cdn.auth0.com/avatars/bh.png?ssl=1"
                                    class="w-14 h-14 rounded-xl border-2 border-blue-100"
