...
<div class="main">
    <h1 class="text-xl font-bold mb-4">HASIL SEMUA <span class="text-purple-600 uppercase">"{{ $query }}"</span>
    </h1>
    <section class="bg-white flex items-center">
        <div class="grid grid-cols-1 xl:grid-cols-4 gap-1.5  py-3  w-full">
            ...
            <a href="/event/{{ $event->slug }}"
                class="uppercase w-full h-auto w-full h-80 overflow-hidden border border-gray-300 inline-block rounded-xl rounded-tl-3xl flex justify-between flex-col">
                ...
                <div class="px-3 pb-3">
                    ...
                    <p class="text-md font-semibold capitalize line-clamp-1">{{ $event->price_range }}</p>
                    <div class="img mt-3 flex items-center gap-3">
                        ...
                        <div class="badge flex items-center justify-center gap-1">
                            <p class="flex justify-center items-center gap-1">{{ $event->creator->fullname }}</p>
