<nav x-data="{ isOpen: false, isSearchFocused: false }" 
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        ...
        <div class="flex items-center flex-1">
            <a href="/" class="flex items-center space-x-2 group relative">
                <img src="/assets/newlogo.png" 
                     class="w-8 sm:w-10 md:w-12 transition-all duration-500 group-hover:scale-110" 
                     alt="Logo Situs">
                <div class="absolute inset-0 rounded-full bg-blue-500/10 scale-0 group-hover:scale-125 transition-transform duration-500"></div>
            </a>

            <!-- Desktop Search -->
            <div class="hidden md:flex flex-1 max-w-2xl ml-4 lg:ml-8">
                <form method="GET" action="/search" class="w-[90%]">
                    <div class="relative" @click.away="isSearchFocused = false">
                        <input type="text" 
                               name="query" 
                               placeholder="Cari event menarik disini..." 
                               @focus="isSearchFocused = true"
                               class="w-full px-4 lg:px-5 py-2 lg:py-2.5 rounded-xl bg-gray-50/80 
        ...
        <div class="hidden md:flex items-center space-x-3 lg:space-x-4">
            ...
            @else
                <a href="{{ route('register') }}" 
                   class="px-4 lg:px-6 py-2 lg:py-2.5 border-2 border-blue-500 
                ...
                <a href="{{ route('login') }}" 
                   class="px-4 lg:px-6 py-2 lg:py-2.5 bg-blue-500 text-white 
        ...
        <button @click="isOpen = !isOpen" 
                class="md:hidden p-2 rounded-lg hover:bg-blue-50 
            ...
            <svg x-show="!isOpen" 
                 ...
                 class="h-5 w-5 sm:h-6 sm:w-6 text-slate-800" 
                 fill="none" 
                 viewBox="0 0 24 24" 
                 stroke="currentColor">
        ...
        <div class="container mx-auto px-4 py-4 space-y-4">
            ...
            @else
                <div class="grid grid-cols-2 gap-3">
                    <a href="{{ route('register') }}" 
                       class="px-4 py-2.5 border-2 border-blue-500 
                    ...
                    <a href="{{ route('login') }}" 
                       class="px-4 py-2.5 bg-blue-500 text-white 
