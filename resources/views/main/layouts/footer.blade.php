    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            <div class="flex items-center space-x-4">
                ...
                <p class="text-gray-600 text-sm">© {{ now()->year }} BookRN.</p>
            </div>
            <nav class="flex flex-col md:flex-row text-center text-gray-600 text-sm">
                <a href="/" class="hover:text-gray-800 m-3">Home</a>
                <a href="/about" class="hover:text-gray-800 m-3">Tentang Kami</a>
                <a href="/privacy" class="hover:text-gray-800 m-3">Kebijakan Privasi</a>
                <a href="/terms" class="hover:text-gray-800 m-3">Syarat & Ketentuan</a>
