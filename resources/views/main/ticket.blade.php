        ...
        <div class="space-y-4">
            ...
            <div
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <h3 class="text-xl font-bold uppercase mb-2">{{ $ticket->ticket }}</h3>
                        <p class="text-2xl text-blue-600 font-bold mb-2">{{ $ticket->ticket_price }}</p>
                        <p class="text-sm text-gray-500">*minimal pemesanan 1 tiket, maksimal 10 tiket</p>
                    </div>
                    @auth
